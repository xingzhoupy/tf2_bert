...
class CompareBertActivationsTest():
    ...
    def test_compare(self):
        ...
        bert_1_seq_out = CompareBertActivationsTest.predict_on_stock_model(model_dir, input_ids, input_mask,
                                                                           token_type_ids)
        bert_2_seq_out = CompareBertActivationsTest.predict_on_keras_model(model_dir, input_ids, input_mask,
                                                                           token_type_ids)
...
if __name__ == "__main__":
    test = CompareBertActivationsTest()
    # test.test_compare()
    test.test_finetune()
